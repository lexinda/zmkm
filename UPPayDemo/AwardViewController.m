...
- (void)viewDidLoad
{
    ...
    self.twoLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.shopLabel.frame.origin.y+self.shopLabel.frame.size.height, self.view.frame.size.width, 30)];
    
    [self.twoLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    ...
    self.threeLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.twoLabel.frame.size.height+self.twoLabel.frame.origin.y, self.view.frame.size.width, 20)];
    
    NSString *threestr = [NSString stringWithFormat:@"奖品编号:%@",[self.award awardNumber]];
    
    [self.threeLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    
    [self.threeLabel setText:threestr];
    
    [self.view addSubview:self.threeLabel];
    
    self.fourLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.threeLabel.frame.size.height+self.threeLabel.frame.origin.y, self.view.frame.size.width, 20)];
    
    [self.fourLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    ...
    self.fiveLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.fourLabel.frame.size.height+self.fourLabel.frame.origin.y, self.view.frame.size.width, 20)];
    
    [self.fiveLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    ...
    self.sixLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.fiveLabel.frame.size.height+self.fiveLabel.frame.origin.y, self.view.frame.size.width, 20)];
    
    [self.sixLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    ...
    self.sivenLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, self.sixLabel.frame.size.height+self.sixLabel.frame.origin.y, self.view.frame.size.width, 20)];
    
    [self.sivenLabel setFont:[UIFont fontWithName:@"Helvetica" size:12.0]];
    ...
    [changeView setFrame:CGRectMake(10.0, self.view.frame.size.height-50-75, self.view.frame.size.width-20.0, 50)];
    
    [changeView setBackgroundImage:[UIImage imageNamed:@"change_award"] forState:UIControlStateNormal];
    
    [changeView setBackgroundImage:[UIImage imageNamed:@"change_award"] forState:UIControlStateSelected];
    ...
    [shareView setFrame:CGRectMake(0.0, self.view.frame.size.height-44-35, self.view.frame.size.width, 35)];
    
    [shareView setBackgroundImage:[UIImage imageNamed:@"share"] forState:UIControlStateNormal];
